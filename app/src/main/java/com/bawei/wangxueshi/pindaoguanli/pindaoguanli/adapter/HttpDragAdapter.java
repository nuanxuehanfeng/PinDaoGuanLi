...
public class HttpDragAdapter extends BaseAdapter {
    /** TAG*/
    ...
    public HttpDragAdapter(Context context, List<TabTitleBean.DataBeanX.DataBean> channelList) {
        this.context = context;
        this.channelList = channelList;
    }
//    public DragAdapter(Context context, List<HttpBean.DataBeanX.DataBean> channelList) {
//        this.context = context;
//        this.channelList = channelList;
//    }
...
//			item_text.setTextColor(context.getResources().getColor(R.color.black));
    ...
    public void exchange(int dragPostion, int dropPostion) {
        ...
        TabTitleBean.DataBeanX.DataBean dragItem = getItem(dragPostion);
