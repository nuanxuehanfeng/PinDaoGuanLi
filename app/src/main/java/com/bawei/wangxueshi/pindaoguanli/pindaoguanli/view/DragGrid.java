package com.bawei.wangxueshi.pindaoguanli.pindaoguanli.view;
...
import com.bawei.wangxueshi.pindaoguanli.pindaoguanli.tools.DataTools;
...
//		if (tempPostion != AdapterView.INVALID_POSITION) {
        ...
        HttpDragAdapter mDragAdapter = (HttpDragAdapter) getAdapter();
        //显示刚拖动的ITEM
...
//        public static final int FLAG_FULLSCREEN     = 0x00000400;
    ...
    private void hideDropItem() {
        ((HttpDragAdapter) getAdapter()).setShowDropItem(false);
    }
